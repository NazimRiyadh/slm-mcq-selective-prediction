...
\centering
\small
\caption{Scope of claims and boundary conditions.}
\label{tab:scope}
...
Where is the result practically applicable? & Finite-choice systems & Most applicable when candidate labels, actions, routes, risk classes, or retrieved answers are explicit and uncertain cases can be escalated. \\
