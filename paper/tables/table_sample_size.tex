...
\par\smallskip
\begin{minipage}{0.96\linewidth}\footnotesize\textit{Note.} ARC-Challenge has 299 validation examples; larger n values are available for the remaining datasets. Increasing sample size narrows variability but does not make hidden-augmented probes clearly dominate cheap features.\end{minipage}
\end{table}
