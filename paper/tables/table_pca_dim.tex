...
\par\smallskip
\begin{minipage}{0.96\linewidth}\footnotesize\textit{Note.} Increasing retained hidden variance does not reliably improve incremental utility, consistent with redundant or noisy high-dimensional signal.\end{minipage}
\end{table}
